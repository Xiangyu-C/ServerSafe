...
cass_session.execute('CREATE TABLE cyber_id.all_predictions (
                     "Timestamp" text,
                     "Source" text,
                     "Destination" text,
                     "Label" text,
...
cass_session.execute('CREATE TABLE cyber_id.count_attack (
                     id text,
                     t timeuuid,
                     a float,
                     b float,
...
cass_session.execute('CREATE TABLE cyber_id.count_traffic (
                     id text,
                     t timeuuid,
                     a float,
                     b float,
